...
func TestSuccessPath(t *testing.T) {
	orchestrator, bus := BuildOrchestrator(nil, nil, nil, nil)
...
func TestPaymentFailureWithInventoryCompensation(t *testing.T) {
	orchestrator, _ := BuildOrchestrator(nil, map[string]bool{"ORDER-PAY-FAIL": true}, nil, nil)
...
func TestShippingFailureWithDoubleCompensation(t *testing.T) {
	orchestrator, _ := BuildOrchestrator(nil, nil, map[string]bool{"ORDER-SHIP-FAIL": true}, nil)
...
func TestInventoryFailureWithoutCompensation(t *testing.T) {
	orchestrator, _ := BuildOrchestrator(map[string]bool{"ORDER-INV-FAIL": true}, nil, nil, nil)
